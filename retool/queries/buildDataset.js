...
// Depends on: fetchAllWeekly, fetchAllDaily, pullRange (all should have run already).
// Ported verbatim from build_dataset.mjs — same merge/aggregation logic, same output shape
// that dashboard.js already expects (this is the exact object to bind into the Custom
// Component's Model as `dataset`).
